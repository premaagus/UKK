<?php 
	...
	$queryTagihan = "SELECT * FROM tbtagihan 
						...
						LEFT JOIN tbpembayaran USING(KodeTagihan)
	...
	if ($data['Status'] == 'Lunas') {
		...
		<body>
			...
			<table align="center" border="1" cellpadding="10" style="border-collapse: collapse;">
				...
				<tr>
					<td>Tanggal Mulai - Akhir Bayar</td>
					<td>:</td>
					<td><?= date('d-M-Y', strtotime($data['TglPencatatan']."+1day")) ?> s/d <?= date('d-M-Y', strtotime($data['TglPencatatan']."+5day")) ?></td>
				</tr>
				<tr>
					<td>Jumlah Pemakaian</td>
					<td>:</td>
			...
			<p align="center">Silahkan membayar tagihan anda dengan transfer ke XXX-XXX-XXX. Upload Bukti pembayaran anda apabila anda sudah membayar</p>
