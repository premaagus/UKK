	...
	<div class="wrapper">
		...
		<div class="content">
			...
			<div class="btn-add btn-info">
				<a href="add.php">Add Tagihan</a>
			</div>
			<div class="table-control">
				<table cellpadding="10" style="border-collapse: collapse; width: 150%;">
					<tr>
						<th>No</th>
						<th>No Tagihan</th>
					...
					<?php 
						$queryList = "SELECT * FROM tbtagihan AS a JOIN tbpelanggan AS b ON a.KodePelanggan = b.KodePelanggan ORDER BY KodeTagihan DESC";
